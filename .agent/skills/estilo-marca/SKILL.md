...
- Estilo visual (colores, tipografías, espaciado): resources/estilo-visual.json
- Forma de escribir (tono, estructura, vocabulario): resources/guia-de-textos.md
- Decisiones técnicas (framework, estilos, librerías): resources/reglas-tecnicas.md

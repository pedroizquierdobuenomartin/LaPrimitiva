...
$appProject = Read-RepositoryFile 'LaPrimitiva.App\LaPrimitiva.App.csproj'
...
Assert-Contains $appCss 'fonts/poppins/poppins-latin-300-normal.woff2' 'No se carga localmente el peso 300 de Poppins.'
Assert-Contains $appCss 'fonts/poppins/poppins-latin-400-normal.woff2' 'No se carga localmente el peso 400 de Poppins.'
Assert-Contains $appCss 'fonts/poppins/poppins-latin-500-normal.woff2' 'No se carga localmente el peso 500 de Poppins.'
